...
keymap("n", "<leader>cd", ":lua require('nvim-tree.api').tree.change_root_to_parent()<CR>", { desc = "Cd into a folder" }, opts)
-- keymap("n", "<leader>cd", function() require("nvim-tree.api").tree.change_root_to_parent() end, { desc = "Change directory to parent folder" })
