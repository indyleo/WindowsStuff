...
keymap("n", "<C-S-l>", ":resize +2<CR>", opts)
...
-- Http Server
keymap("n", "<leader>hn", ":lua HttpServer(Start)<CR>", { desc = "Start http server" }, opts)
keymap("n", "<leader>hf", ":lua HttpServer(Stop)<CR>", { desc = "Stop http server" }, opts)
...
-- Nvim Tree
keymap("n", "<leader>ee", ":NvimTreeToggle<CR>", { desc = "Toggle file explorer" }, opts)
keymap("n", "<leader>ef", ":NvimTreeFindFileToggle<CR>", { desc = "Toggle file explorer on current file" }) -- toggle file explorer on current file
keymap("n", "<leader>ec", ":NvimTreeCollapse<CR>", { desc = "Collapse file explorer" }) -- collapse file explorer
keymap("n", "<leader>er", ":NvimTreeRefresh<CR>", { desc = "Refresh file explorer" }) -- refresh file explorer
keymap("n", "<leader>eb", ":NvimTreeClipboard<CR>", { desc = "Show whats in Nvim-tree clipboard" }) -- refresh file explorer
keymap("n", "<leader>cn", ":lua require('nvim-tree.api').tree.change_root_to_node()<CR>", { desc = "Cd into a child directory" }, opts)
keymap("n", "<leader>cp", ":lua require('nvim-tree.api').tree.change_root_to_parent()<CR>", { desc = "Cd into a parent directory" }, opts)
...
keymap("n", "<leader>fn", ":Telescope notify<CR>", { desc = "Opens undo managment" }, opts)
